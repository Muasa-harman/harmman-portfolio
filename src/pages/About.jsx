...
const About = () => {
  return (
    <div className="about">
      ...
      <h2 className="links">
        <Link target='_blank' to="https://www.linkedin.com/in/harman-muasa-fullstackdev?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3Bw5yXCVfBQ82Nfyn6WXRnhA%3D%3D" blank="">
        <img
        ...
        <Link target='_blank' to="https://github.com/Muasa-harman">
        <img
          className="social" src="https://github.githubassets.com/assets/GitHub-Mark-ea2971cee799.png"
          alt=""
        />
        </Link>
        <Link target='_blank' to="http://www.youtube.com/@techworldevs">
        <img
        ...
        <Link target='_blank' to="https://podcasters.spotify.com/pod/show/harman-muasa1">
        <img
