    ...
    <div>
      <div className="interests">
        ...
        <p className="interest">
          ...
          Whether its trekking through scenic mountains, discovering hidden
          ...
          My interest in tourism and travel isnt just a hobby; its a
          continuous journey of self-discovery and understanding. Exploring new
          places goes beyond sightseeing for me; its about connecting with
        ...
        <p className="interest">
          My outdoor escapades, whether hiking along scenic
           trails or strolling
          ...
          nature. Through my travels, Ive had the privilege of witnessing the
